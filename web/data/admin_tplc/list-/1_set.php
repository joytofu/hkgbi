...
<?php if($m_rs[if_biz]){?>
	...
	<div class="table">
		<div class="left"><b><span class="red">*分类搜索</span></b>：</div>

             <p>
            <select name="s_rg" id="s_rg">
             <option value="">投资年份</option>
                     	<?php 
    $result1=mysql_query("select * from juniu2_list where module_id=110 order by taxis desc,id desc");
while ($rs1=mysql_fetch_array($result1))
{;?>
<option value="<?php echo $rs1[title];?>" <?php if($rs[s_rg]==$rs1[title]){?> selected="selected"<?php } ?>><?php echo $rs1[title];?></option>
...
<select name="s_ns" id="s_ns">
                         <option value="">基金净值</option>
                                        	<?php 
    $result1=mysql_query("select * from juniu2_list where module_id=111 order by taxis desc,id desc");
while ($rs1=mysql_fetch_array($result1))
{;?>
<option value="<?php echo $rs1[title];?>" <?php if($rs[s_ns]==$rs1[title]){?> selected="selected"<?php } ?>><?php echo $rs1[title];?></option>
...
<select name="s_qx" id="s_qx">
                         <option value="">投资门槛</option>
                                     	<?php 
    $result1=mysql_query("select * from juniu2_list where module_id=112 order by taxis desc,id desc");
while ($rs1=mysql_fetch_array($result1))
{;?>
<option value="<?php echo $rs1[title];?>" <?php if($rs[s_qx]==$rs1[title]){?> selected="selected"<?php } ?>><?php echo $rs1[title];?></option>
