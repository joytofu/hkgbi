...
<div class="main">
   ...
   <div class="right">
      <div class="righttop"><div class="ll"><?php echo $rs[cate_name];?></div><div class="rr">您当前的位置是：<a href="<?php echo $_sys[siteurl];?>">网站首页</a> > <?php echo $rs[title];?> >在线预约</div></div>
      ...
      <div class="rightmain">
       <form id="form1" name="form1" method="post" onsubmit="return check()" action="deal.php">
	    <table width="90%" border="0" cellspacing="1" cellpadding="0"  style="margin:10px auto" id="cvf">
	      <tr>
	        <td width="24%" align="right">基金名称：</td>
	        <td width="76%">
	          <select name="title" type="text" id="title"  class="text1"/>
	      ...
	      <tr>
	        ...
	        <td>  <input type="submit" name="button2" id="button2" value="预约" style=" width:50px; height:25px;  float:left" />
