...
<div class="pro_bg">
   <h1 class="pro_top">巨牛-好运来一号</h1>
   <div class="clear"></div>

    <?php $fund_values = phpok_c_list("haoyunlai_value","100","","post_asc");?>
    <?php 
...
<div id="tabs1">
 ...
 <div class="main1box">
  ...
  <?php echo $rs[content];?>
      ...
      <ul><div id="haoyunlai" style="width:1200px;height:70%"></div>
      </ul>

  </div>
 </div>
</div>
<?php $svg = phpok_c_list("haoyunlai_value","100","","post_asc");?>
<script type="text/javascript">
    ...
    <?php } ?>
        ...
        name: '沪深300',
            ...
            <?php 
            //$hs_index = array();
            $hs_orgin=3513.58;    //沪深300初始值--基金成立当日收盘价格
