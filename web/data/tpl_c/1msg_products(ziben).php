...
<!-- include file=../get_juniu.php -->


<div class="pro_bg">
   <h1 class="pro_top">巨牛-中金岭南金汇资本一号</h1>
   <div class="clear"></div>
   
  <div class="pro_li1">单位净值<br /><span class="sese"><?php echo $rs[a2];?></span></div>
  <div class="pro_li2">净值日期<br /><span class="sese"><?php echo $rs[a3];?></span></div>
  <div class="pro_li3">累计净值<br /><span class="sese"><?php echo $rs[a4];?></span></div>
   ...
   <div class="pro_li3">今年以来收益率<br /><span class="sese"><?php echo $rs[a6];?></span></div>
...
<li onmouseover="setTab(1,2)">我要预约</li>
 ...
 <div class="main1box">
  ...
  <?php echo $rs[content];?>
      ...
      <ul><div id="ziben" style="width:1200px;height:70%"></div>
   <ul>
      <form style="margin-left:10%" id="form1" name="form1" method="post" onsubmit="return check()" action="deal.php">
	    <table width="90%" border="0" cellspacing="1" cellpadding="0"  style="margin:10px auto" id="cvf">
	      <tr style="display:none">
	        ...
	        <td width="75%">
	          <input name="title" type="text" id="title" size="50" value="中金岭南金汇资本一号"  class="text1"/>
...
//
    ...
    <?php $svg = phpok_c_list("ziben_value","100","","post_asc");?>
    <script type="text/javascript">
        $(function () {
