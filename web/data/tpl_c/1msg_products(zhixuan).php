...
<div class="pro_bg">
   <h1 class="pro_top">巨牛-智选一号</h1>
   <div class="clear"></div>

    <?php $fund_values = phpok_c_list("zhixuan_value","100","","post_asc");?>
    <?php 
  ...
  <div class="pro_li3">累计净值<br /><span class="sese"><?php echo $fund_values[rslist][$size-1][value];?></span></div>
   ...
   <div class="pro_li1" style="width: 140px">投资类型<br /><span class="sese" style="font-size:17px"><?php echo $cate_rs[cate_name];?></span></div>
...
<li onmouseover="setTab(1,2)">我要预约</li>
 ...
 <div class="main1box">
  ...
  <?php echo $rs[content];?>
      ...
      <ul><div id="zhixuan" style="width:1200px;height:70%"></div>
      </ul>
   <ul>
      <form style="margin-left:10%" id="form1" name="form1" method="post" onsubmit="return check()" action="deal.php">
	    <table width="90%" border="0" cellspacing="1" cellpadding="0"  style="margin:10px auto" id="cvf">
	      <tr style="display:none">
	        ...
	        <td width="75%">
	          <input name="title" type="text" id="title" size="50" value="智选一号"  class="text1"/>
...
//
    ...
    <?php $svg = phpok_c_list("zhixuan_value","100","","post_asc");?>
    <script type="text/javascript">
        $(function () {
        ...
        <?php } ?>
            ...
            name: '沪深300',
                ...
                <?php 
                //$hs_index = array();
                $hs_orgin=4754.92;    //沪深300初始值--基金成立当日收盘价格
