<?php if(!defined('PHPOK_SET')){die('<h3>Error...</h3>');}?><div class="index_2"> <?php $dibu = phpok_msg("lx");?>
<?php echo nl2br($dibu[note]);?></div>
<div class="foot">
...
<script>
	window._bd_share_config = {
		...
		image : [{
			...
			viewColor : 'black',
			viewSize : '32',
			viewList : ['weixin','tsina','qzone','tqq','douban','tieba','iguba','print','copy']
		}],
		selectShare : [{
			"bdselectMiniList" : ['weixin','tsina','qzone','tqq','douban','tieba','iguba','print','copy']
		}]
	}
...
<script type="text/javascript">uaredirect("http://mobile.hkgbi.com","http://hkgbi.com");</script>
...
(function() {
  ...
  hm.src = "//hm.baidu.com/hm.js?f34e38de2157dfa0a58d9854578ef373";
