...
<div class="main">
   ...
   <div class="right">
      <div class="righttop"><div class="ll" style="width:300px;">渠道代理商</div><div class="rr" style="width:600px;">您当前的位置是：<a href="<?php echo $_sys[siteurl];?>">网站首页</a> > <?php echo $rs[title];?> > 渠道代理商</div></div>
      
      <div class="rightmain">
      <div style="font-size:14px;">
          <p>诚征各区域代理合作伙伴，产品可包括私募基金、固定收益类信托、香港保险以及资产管理项目等。

</p><br>

              <p><strong>合作条件：</strong><br>个人或机构不限，有行业经验优先；注重商誉，共享共赢。</p><br>

              <p><strong>限制：</strong><br>设立一区一代制，以城市为单位，不重复设立分部或授权代理人员。
</p><br>
          ...
          <form id="form1" name="cooperation" method="post" onsubmit="return check()" action="deal.php">
              <input name="title" type="text" id="title" size="50" value="渠道代理商"  class="text1" style="display:none"/>
